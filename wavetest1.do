...
add wave -noupdate /test/tr_mode_enable
...
add wave -noupdate -format Analog-Step -height 74 -max 80000.0 -radix unsigned /test/TR_test/N
add wave -noupdate -radix unsigned /test/drv_enable_SM
