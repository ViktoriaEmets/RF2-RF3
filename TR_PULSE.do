...
add wave -noupdate -format Analog-Step -height 74 -max 65534.999999999993 -radix unsigned /test/TR_test/dx
...
update
WaveRestoreZoom {10219930 ns} {55418990 ns}
